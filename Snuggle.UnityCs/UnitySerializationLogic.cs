...
public class TypeResolver {
    ...
    public TypeResolver(IGenericInstance typeDefinitionContext) => _typeDefinitionContext = typeDefinitionContext;
    ...
    private TypeReference GenericArgumentAt(string key, int position) => _context[key].GenericInstance.GenericArguments[position];
...
public static class UnitySerializationLogic {
    ...
    public static bool IsUnityEngineObject(TypeReference typeReference) => UnityEngineTypePredicates.IsUnityEngineObject(typeReference);
