...
public record PBRMaterial : Property {
    ...
    /// The first three components (RGB) <b>MUST</b> be encoded with the sRGB transfer function.
    ...
    /// The stored texels <b>MUST NOT</b> be premultiplied.
    /// When undefined, the texture <b>MUST</b> be sampled as having `1.0` in all components.
    /// </summary>
    ...
    /// These values <b>MUST</b> be encoded with a linear transfer function.
    /// If other channels are present (R or A), they <b>MUST</b> be ignored for metallic-roughness calculations.
    /// When undefined, the texture <b>MUST</b> be sampled as having `1.0` in G and B components.
    /// </summary>
