...
public record Accessor : ChildOfRootProperty {
    ...
    /// When undefined, the accessor <b>MUST</b> be initialized with zeros; `sparse` property or extensions <b>MAY</b> override zeros with actual values.
    /// </summary>
    ...
    /// This <b>MUST</b> be a multiple of the size of the component datatype.
    /// This property <b>MUST NOT</b> be defined when `bufferView` is undefined.
    /// </summary>
    ...
    /// UNSIGNED_INT type <b>MUST NOT</b> be used for any accessor that is not referenced by `mesh.primitive.ndices`.
    /// </summary>
    ...
    /// This property <b>MUST NOT</b> be set to `true` for accessors with `FLOAT` or `UNSIGNED_INT` component type.
    /// </summary>
    ...
    /// Array elements <b>MUST</b> be treated as having the same data type as accessor's `componentType`.
    ...
    /// When the accessor is sparse, this property <b>MUST</b> contain maximum values of accessor data with sparse substitution applied.
    /// </summary>
    ...
    /// The length is determined by the value of the `type` property; it can be 1, 2, 3, 4, 9, or 16.
    /// `normalized` property has no effect on array values: they always correspond to the actual values stored in the buffer.
    /// When the accessor is sparse, this property <b>MUST</b> contain minimum values of accessor data with sparse substitution applied.
    /// </summary>
