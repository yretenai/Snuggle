...
public record OculusSettings(
    ...
    public static OculusSettings FromReader(BiEndianBinaryReader reader, SerializedFile file) {
        ...
        var signing = false;
        if (file.Version >= UnityVersionRegister.Unity2018_4 &&
            file.Version < UnityVersionRegister.Unity2019_1 ||
            file.Version >= UnityVersionRegister.Unity2019_2) {
            lowOverhead = reader.ReadBoolean();
        }

        if (file.Version >= UnityVersionRegister.Unity2018_4 &&
            file.Version < UnityVersionRegister.Unity2019_1 ||
            file.Version >= UnityVersionRegister.Unity2019_3) {
