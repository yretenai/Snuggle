...
public class UnityVersionTests {
    [TestCase("2019.4.15f1", 2019, 4, 15, UnityBuildType.Final, 1, 0)]
    [TestCase("2019.4.15f1\n2", 2019, 4, 15, UnityBuildType.Final, 1, 2)]
    [TestCase("2019.4.15f1-2", 2019, 4, 15, UnityBuildType.Final, 1, 2)]
    [TestCase("5.x.x", 5, 0, 0, UnityBuildType.None, 0, 0)]
